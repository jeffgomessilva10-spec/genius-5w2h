...
const { listPdca, createReview, deleteReview, createLesson, deleteLesson, moveReview } = require('../controllers/pdca.controller');
...
router.patch('/reviews/:id/phase',   authorize('ADMIN', 'COLLABORATOR'), moveReview);
